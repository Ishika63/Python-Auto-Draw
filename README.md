...
* Clone this into your Desktop: `git clone "https://github.com/Ishika63/Python-Auto-Draw.git"`
* Open Command Line or Terminal 
* Change directory to a respective game: `cd "Desktop\Python-Auto-Draw"`
